function results = pendulMOD(NumericalMethod,theta0,tau,nstep)
%% pendul - Program to compute the motion of a simple pendulum
% Invoke as (for example): pendulMOD(2,10,0.1,300)
% using the Euler or Verlet method
help pendul      % Clear the memory and print header
% Source: Alejandro L. Garcia (Numerical Methods For Physics);
% modified by Leslie Morocho 20200406
