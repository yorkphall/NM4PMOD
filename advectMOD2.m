function advect = advectMOD2(method, N, tau, nStep)     %MOD
%% advect - Program to solve the advection equation 
% using the various hyperbolic PDE schemes
% clear all;                                            %MOD
help advect;  % Clear memory and print header
%% Phys 2030 HW 12 Bonus by Hossam EL-Shebiny 214163240
% Modified for running from command line
% Original by AJG; 
% Modified by Hossam EL-Shebiny 20200406
% Invoke as: advectMOD2(3, 10, 0.1, 100) %Example
% Method 1 = FTCS; Method 2 = Lax; Method 3 = Lax-Wendroff
%
%% * Select numerical parameters (time step, grid spacing, etc.).
% method = menu('Choose a numerical method:', ...       %MOD
