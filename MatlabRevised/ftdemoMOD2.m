function results= ftdemoMOD(N,freq,phase,Method); %MOD
% Where N is number of points %MOD
%freq is frequency of the sine wave%MOD
%Phase is phase of the sine wave %MOD
%Method is the method used, whether Direct summation or FFT %MOD

%Invoke as (for example): ftdemoMOD(200,0.2,0,1)

% Original by AJG; modified by Hya Mohamed 20200405 %MOD
