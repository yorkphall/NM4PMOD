function[output]= lorenzMOD(state,r,nstep) %MOD
%Original by AJG; modified by Palvisha Sharma 20200406 

% lorenz - Program to compute the trajectories of the Lorenz 
% equations using the adaptive Runge-Kutta method.
% Example of how to call the function: lorenzMOD([4,5,5],20,5)
 help lorenzMOD; %MOD
