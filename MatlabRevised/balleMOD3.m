function outputvalues = balleMOD3(y1,speed,theta,tau,airFlag)% MOD
% balleMOD3 - Program to compute the trajectory of a baseball using the Euler
% method.                                                    %MOD
% invoke as:  balleMOD3(0,50,45,0.5,1)		                 %MOD
% y1 is the initial height in meters                         %MOD
% speed is the initial speed in meters per second            %MOD
% theta is the initial angle in degrees                      %MOD
% tau is the number of timesteps in sec                      %MOD
% airFlag is the Air resistance. Presence of air resistance  %MOD
% is 1 and if not it is 0                                    %MOD
% Original by AJG; modified by Vithurshan Suthakar 20200401  %MOD
help balleMOD3;	% Print header                               %MOD
