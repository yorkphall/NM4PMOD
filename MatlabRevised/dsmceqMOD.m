...
% Original by AJG; modified by Patrick Hall 20200326 %MOD
help dsmceqMOD;	% Print header %MOD
%clear all;  help dsmceq;   % Clear memory and print header %MOD
...
%npart = input('Enter number of simulation particles: '); %MOD
...
histogram(vmag,vbin);  title('Initial speed distribution'); %MOD
...
%nstep = input('Enter total number of time steps: '); %MOD
for istep = 1:nstep
